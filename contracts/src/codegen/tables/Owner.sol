...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("Owner")))
);
ResourceId constant OwnerTableId = _tableId;
...
library Owner {
  ...
  function getValue(IStore _store) internal view returns (address value) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  /** Get value (using the specified store) */
  function get(IStore _store) internal view returns (address value) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function setValue(IStore _store, address value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  /** Set value (using the specified store) */
  function set(IStore _store, address value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
